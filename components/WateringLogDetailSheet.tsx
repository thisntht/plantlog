...
export function WateringLogDetailSheet({
  ...
  }, [log.id, memo, plantConditions, soilStatus, updateWateringLog, user, waterAmount, wateredDate]);
    ...
    >
      <div className="space-y-5">
        <div className="rounded-lg border border-neutral-200 bg-white p-4">
          ...
          <p className="mt-1 text-xs text-neutral-400">{saveState === "saving" ? "저장 중" : saveState === "saved" ? "저장됨" : "자동 저장"}</p>
        </div>
